...
- [x] **SEO-08
**: OG image asset uses a versioned filename (e.g. `og-image-v1.png`); deploy runbook documents Facebook Sharing Debugger force-refresh after content changes.
- [x] **SEO-09
...
- [x] **LAND-01
**: Marketing landing page at `/` — hero pitch, value proposition, screenshot(s), install CTA, FAQ, footer. Hand-authored static HTML; no React.
- [x] **LAND-02
...
- [x] **LAND-03
**: Install CTA — Android browsers see a `beforeinstallprompt`-driven install button; iOS Safari users see manual "Share → Add to Home Screen" instructions (no automatic prompt — iOS does not support `beforeinstallprompt`).
- [x] **LAND-04
**: FAQ section on landing — plain HTML `<h3>` + paragraph Q&A. No `FAQPage` JSON-LD (Google deprecated rich-result eligibility for non-gov/health sites in 2023).
- [x] **LAND-05
**: iOS honesty section explicitly states the locked-screen alarm limitation (pure PWAs cannot fire audio when iPhone is locked) and recommends home-screen install + keeping the app foregrounded for reliability.
- [x] **LAND-06
...
| SHR-01 | Phase 9 | Complete |
| SHR-02 | Phase 9 | Complete |
| SHR-03 | Phase 9 | Complete |
| SHR-04 | Phase 9 | Complete |
